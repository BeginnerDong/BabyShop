<template>
	<view>
		...
		<view class="pdtb15">
			...
			<view class="fs15 ftw red pdlr4 mgt10">￥88</view>
		</view>
		...
		<view class="xqbotomBar pdl15 center" style="height: 100rpx;">
			<view class="ite flexCenter fs12">
			...
			<view class="payBtn" style="width: 500rpx;" @click="Router.navigateTo({route:{path:'/pages/orderConfim/orderConfim'}})">立即购买</view>
		</view>
